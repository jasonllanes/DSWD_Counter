  ...
  return (
    <div className="flex items-center justify-center w-screen h-screen bg-background ">
      <div className=" min-w-[300px] w-[50%] flex flex-col items-center">
        ...
        <p className="mt-3 text-lg font-medium text-accent-foreground">
        ...
        <Button asChild className=" my-3 animate-pulse ">
          <Link to="/dswd-counter" className=" flex gap-2 items-center">
            <Home className="h-[1.2rem] w-[1.2rem]" /> Go Home{" "}
          </Link>
        </Button>
      </div>
    </div>
