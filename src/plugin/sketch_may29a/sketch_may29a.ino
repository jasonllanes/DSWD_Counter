...
if (ProductionDivHr==1)
{
  ...
  // Print both total counts and rates
  Serial.println("=== Production Data ===");
  Serial.print("L1 Total: ");
  Serial.print(L1);
  Serial.print(", Rate: ");
  Serial.println(rateL1);
  
  Serial.print("L2 Total: ");
  Serial.print(L2);
  Serial.print(", Rate: ");
  Serial.println(rateL2);
  
  Serial.print("L3 Total: ");
  Serial.print(L3);
  Serial.print(", Rate: ");
  Serial.println(rateL3);
  
  Serial.print("L4 Total: ");
  Serial.print(L4);
  Serial.print(", Rate: ");
  Serial.println(rateL4);
  
  Serial.print("L5 Total: ");
  Serial.print(L5);
  Serial.print(", Rate: ");
  Serial.println(rateL5);
  
  Serial.print("L6 Total: ");
  Serial.print(L6);
  Serial.print(", Rate: ");
  Serial.println(rateL6);
  
  Serial.print("L7 Total: ");
  Serial.print(L7);
  Serial.print(", Rate: ");
  Serial.println(rateL7);
  
  Serial.print("L8 Total: ");
  Serial.print(L8);
  Serial.print(", Rate: ");
  Serial.println(rateL8);
  Serial.println("=====================");
